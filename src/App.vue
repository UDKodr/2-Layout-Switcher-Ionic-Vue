            ...
            <ion-list id="labels-list">
              ...
              <ion-item>
                ...
                <ion-select
                  ...
                  v-model="mainScreenLayout"
                  @ionChange="setLayout($event.detail.value)"
                >
                  <ion-select-option value="Card">Card</ion-select-option>
                  <ion-select-option value="Grid">Grid</ion-select-option>
...
export default defineComponent({
  ...
  methods: {
      ...
      localStorage.setItem("mainScreenLayout", value);
      store.setLayouts();
    },
    async openModal() {
